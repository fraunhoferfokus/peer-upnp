				...
				if (err) {
					...
					try {
						...
						new Promise(function (resolve, reject) {
							try {
								resolve(service.implementation[actionName].call(service, inputs) || {})
							} catch (e) {
								reject(e)
							}
						})
							.then(function (outputs) { return Object.assign(options, { outputs: outputs}) })
							.catch(function (e) { return Object.assign(options, { error: new UPnPError(e.message, 501) }) })
